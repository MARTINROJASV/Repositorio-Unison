...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $oficios_recibidos_f->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Oficios_Recibidos_fs", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/oficios_recibidos_fs/'.$oficios_recibidos_f->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Oficios_Recibidos_fs", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.oficios_recibidos_fs.destroy', $oficios_recibidos_f->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/oficios_recibidos_fs') }}" data-toggle="tooltip" data-placement="right" title="Back to Oficios Recibidos fs"><i class="fa fa-chevron-left"></i></a></li>
