...
<div id="headerwrap">
    <div class="container">
        <div class="row centered">
            ...
            <div class="col-lg-2">
            <!--    <h5>Increibles funcionalidades</h5>
                <p>Administra mas facil con panel</p>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-5 centered">
                <img class="centered" src="{{ asset('/la-assets/img/EXAMPLE.png') }}" alt="">
            </div>

            <div class="col-lg-7">
				<h3 class="feature-title">¿Qué es el repositorio ?</h3><br>
				<ol class="features">
					<li><!--<strong>CMS</strong> (sistema de gestión de contenido) &#8211; -->Gestiona módulos y sus datos</li>
					<li><!--Backend <strong>Admin Panel</strong> &#8211; -->Los datos se pueden usar con facilidad, sin limite de tamaño.</li>
...
<div id="footerwrap">
    <div class="container">
        <div class="col-lg-5">
            <h3>SOPORTE</h3><br>
            <p>
                Área de Sistemas Informáticos Financieros	,<br/>
                José Martín Rojas Valenzuela,<br/>



            </p>
			<div class="contact-link"><i class="fa fa-envelope-o"></i> <a href="mailto:martin.rojas@unison.mx">martin.rojas@unison.mx</a></div>
...
<div id="c">
    <div class="container">
        <p>
            <strong>Copyright &copy; 2020. Powered by <a href="https://www.unison.mx///"><b>UNISON</b></a>
        </p>
    </div>
</div>
