...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $dir_universidad->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Dir_universidads", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/dir_universidads/'.$dir_universidad->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Dir_universidads", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.dir_universidads.destroy', $dir_universidad->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/dir_universidads') }}" data-toggle="tooltip" data-placement="right" title="Back to Dir universidads"><i class="fa fa-chevron-left"></i></a></li>
