...
$(function () {
	...
	fm_dropzone_main = new Dropzone("#fm_dropzone_main", {
        maxFilesize: 200000,
        acceptedFiles: "image/*,application/pdf,text/csv,application/vnd.ms-excel,application/vnd.openxmlformats-officedocument.spreadsheetml.sheet,application/zip,application/octet-stream,application/x-zip-compressed,multipart/x-zip,.zip",
        init: function() {
...
function formatFile(upload) {
    ...
    if($.inArray(upload.extension, ["jpg", "jpeg", "png", "gif", "bmp"]) > -1) {
        ...
        switch (upload.extension) {
            ...
            case "zip":
                image = '<i class="fa fa-file-archive-o" ></i>';
                break;
