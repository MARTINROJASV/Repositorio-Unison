...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $directorio_auditore->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Directorio_auditores", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/directorio_auditores/'.$directorio_auditore->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Directorio_auditores", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.directorio_auditores.destroy', $directorio_auditore->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/directorio_auditores') }}" data-toggle="tooltip" data-placement="right" title="Back to Directorio auditores"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						@la_display($module, 'correoelectronico')
						@la_display($module, 'telefonooficina')
						@la_display($module, 'telefonocelular')
