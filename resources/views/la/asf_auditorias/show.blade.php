...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $asf_auditoria->$view_col }}</h4>
					<!--<div class="row stats">
		...
		<div class="col-md-3">
			...
			<div class="dats1"><i class="fa fa-envelope-o"></i> superadmin</div>
			<div class="dats1"><i class="fa fa-map-marker"></i> Hermosillo, UNISON</div>
		</div>
		<div class="col-md-4">
			<!--
			<div class="teamview">
		...
		<div class="col-md-1 actions">
			@la_access("ASF_AUDITORIAS", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/asf_auditorias/'.$asf_auditoria->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("ASF_AUDITORIAS", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.asf_auditorias.destroy', $asf_auditoria->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/asf_auditorias') }}" data-toggle="tooltip" data-placement="right" title="Back to ASF AUDITORIAS"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'numeroauditoria')
						@la_display($module, 'nombreauditoria')
						@la_display($module, 'programapresupuest')
					</div>
				</div>
			</div>
		</div>
