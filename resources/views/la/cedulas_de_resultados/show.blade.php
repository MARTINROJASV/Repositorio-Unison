...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $cedulas_de_resultado->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Cedulas_de_resultados", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/cedulas_de_resultados/'.$cedulas_de_resultado->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Cedulas_de_resultados", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.cedulas_de_resultados.destroy', $cedulas_de_resultado->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/cedulas_de_resultados') }}" data-toggle="tooltip" data-placement="right" title="Back to Cedulas de resultados"><i class="fa fa-chevron-left"></i></a></li>
