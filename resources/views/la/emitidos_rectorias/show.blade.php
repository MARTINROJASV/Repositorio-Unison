...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $emitidos_rectoria->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Emitidos_Rectorias", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/emitidos_rectorias/'.$emitidos_rectoria->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Emitidos_Rectorias", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.emitidos_rectorias.destroy', $emitidos_rectoria->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/emitidos_rectorias') }}" data-toggle="tooltip" data-placement="right" title="Back to Emitidos Rectorias"><i class="fa fa-chevron-left"></i></a></li>
