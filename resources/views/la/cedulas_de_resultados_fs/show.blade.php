...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $cedulas_de_resultados_f->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Cedulas_de_resultados_fs", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/cedulas_de_resultados_fs/'.$cedulas_de_resultados_f->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Cedulas_de_resultados_fs", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.cedulas_de_resultados_fs.destroy', $cedulas_de_resultados_f->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/cedulas_de_resultados_fs') }}" data-toggle="tooltip" data-placement="right" title="Back to Cedulas de resultados fs"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'nodeoficio')
						@la_display($module, 'fecha')
						@la_display($module, 'direccionemiteofc')
						@la_display($module, 'fechapresentacion')
						@la_display($module, 'lugar')
						@la_display($module, 'fechaacta')
						@la_display($module, 'nodeacta')
						@la_display($module, 'documentoescaneado')
						@la_display($module, 'numderesultados')
						@la_display($module, 'observacionunison')
						@la_display($module, 'sinobservaciones')
						@la_display($module, 'observaciongobedo')
						@la_display($module, 'plazoparaatencion')
						@la_display($module, 'fechadevencimiento')
