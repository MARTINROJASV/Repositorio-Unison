...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $ofc_orden_auditoria->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Ofc_orden_auditorias", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/ofc_orden_auditorias/'.$ofc_orden_auditoria->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Ofc_orden_auditorias", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.ofc_orden_auditorias.destroy', $ofc_orden_auditoria->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/ofc_orden_auditorias') }}" data-toggle="tooltip" data-placement="right" title="Back to Ofc orden auditorias"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						@la_display($module, 'fechainicioauditor')
						@la_display($module, 'fechaactaauditoria')
						@la_display($module, 'nodeacta')
						@la_display($module, 'comentarios')
						@la_display($module, 'documentoescaneado')
						@la_display($module, 'agendaractividad')
