...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $lista_de_nombre->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Lista_de_nombres", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/lista_de_nombres/'.$lista_de_nombre->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Lista_de_nombres", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.lista_de_nombres.destroy', $lista_de_nombre->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/lista_de_nombres') }}" data-toggle="tooltip" data-placement="right" title="Back to Lista de nombres"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'lugarqueemite')
						@la_display($module, 'nombrelistado')
					</div>
				</div>
			</div>
		</div>
