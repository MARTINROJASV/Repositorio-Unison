...
@section('htmlheader_title')
	Resultado Observaciones f View
@endsection
...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $resultado_observaciones_f->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Resultado_Observaciones_fs", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/resultado_observaciones_fs/'.$resultado_observaciones_f->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Resultado_Observaciones_fs", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.resultado_observaciones_fs.destroy', $resultado_observaciones_f->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/resultado_observaciones_fs') }}" data-toggle="tooltip" data-placement="right" title="Back to Resultado Observaciones fs"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						@la_display($module, 'descripcionresultado')
						@la_display($module, 'documentoescaneado')
						@la_display($module, 'direccionresponsable')
						@la_display($module, 'num')
